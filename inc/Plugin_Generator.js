...
module.exports = class Plugin_Generator {
    ...
    generate(){
        ...
        const main_file = new File_Generator();
            main_file
                ...
                if( this.panel_slug.length ){
                    main_file
                        .star_comment('Panel Constants')
                        .line( `define( '${this.constant_prefix}_PANEL_PATH', ${this.constant_prefix}_DIR . 'Panel/' );` )
                        .line( `define( '${this.constant_prefix}_PANEL_ASSETS_PATH', ${this.constant_prefix}_DIR . 'assets/panel/' );` )
                        .line();
                }
    ...
    generate_panel(){
        ...
        panel
            ...
            .line( `private string $panel_slug = '${this.panel_slug}';`, 1 )
            .line('', 1 )
            .line( `private array $assets;`, 1 )
            .line( '', 1 )

            .line( 'public function __construct(){', 1 )
                .line( '//panel constructor class code here', 2 )
            .line( '}', 1 )
            .line( '', 1 )

            .line( 'public function register(){', 1 )
                .line( '', 2 )
                .line( 'add_action( \'init\', [$this, \'register_rewrite_rule\'] );', 2 )
                .line( 'add_action( \'query_vars\', [$this, \'query_vars\'] );', 2 )
